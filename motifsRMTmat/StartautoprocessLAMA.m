...
PATH_dataset ='/Users/bzcschae/workspace/multidim_motifs/SMM_test/BENCHMARK/';
saveFeaturesPath='/Users/bzcschae/workspace/multidim_motifs/SMM_test/BENCHMARK/MotifsFeatures/';
...
for TSname = 1:TS_num    
    ...
    disp(['EXECUTING JOB ON TIMESERIES: ', PATH_dataset, TS_name]);
    %% TIMER
    TIMEFOROCTAVE = 0;
    ...
    if FeatureExtractionFlag == 1
        ...
        TIMEFOROCTAVE = LAMA_FE_start(PATH_dataset,saveFeaturesPath, TS_name, USER_OT_targhet, USER_OD_targhet);
    end
